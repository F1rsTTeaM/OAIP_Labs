// ЛР №25 Ладягин ПИбд-13.cpp : Определяет точку входа для приложения.
//

#include "framework.h"
#include "ЛР №25 Ладягин ПИбд-13.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MY2513, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY2513));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MY2513));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_MY2513);
...
void RecursiveImage4_7(HDC hdc, int cx, int cy, int size) {
    ...
    RecursiveImage4_7(hdc, cx, cy - size, size / 2);
    RecursiveImage4_7(hdc, cx - size, cy, size / 2);
    RecursiveImage4_7(hdc, cx + size, cy, size / 2);
}
    ...
    case WM_PAINT:
        {
            ...
            //Задача 1
            /*RecursiveImage1_1(hdc, 150, 80, 80);
            RecursiveImage1_2(hdc, 500, 150, 80);
            RecursiveImage1_3(hdc, 800, 150, 80);
            RecursiveImage1_4(hdc, 150, 450, 80);
            RecursiveImage1_5(hdc, 400, 450, 80);
            RecursiveImage1_6(hdc, 800, 450, 80);
            RecursiveImage1_7(hdc, 1100, 450, 80);*/
            //Задача 2
            /*RecursiveImage2_1(hdc, 200, 150, 80);
            RecursiveImage2_2(hdc, 500, 150, 80);
            RecursiveImage2_3(hdc, 800, 150, 80);
            RecursiveImage2_4(hdc, 1150, 150, 80);
            RecursiveImage2_5(hdc, 200, 400, 80);
            RecursiveImage2_6(hdc, 400, 400, 80);
            RecursiveImage2_7(hdc, 800, 400, 80);*/
            //Задача 3
            /*RecursiveImage3_1(hdc, 200, 150, 80);
            RecursiveImage3_2(hdc, 550, 150, 80);
            RecursiveImage3_3(hdc, 900, 150, 80);
            RecursiveImage3_4(hdc, 1300, 150, 80);
            RecursiveImage3_5(hdc, 200, 500, 80);
            RecursiveImage3_6(hdc, 500, 500, 80);
            RecursiveImage3_7(hdc, 1300, 500, 80);
            RecursiveImage3_8(hdc, 900, 500, 80);*/
            //Задача 4
            RecursiveImage4_1(hdc, 200, 150, 80);
            RecursiveImage4_2(hdc, 500, 150, 80);
            RecursiveImage4_3(hdc, 800, 150, 80);
            RecursiveImage4_4(hdc, 200, 500, 80);
            RecursiveImage4_5(hdc, 600, 500, 80);
            RecursiveImage4_6(hdc, 950, 500, 80);
            RecursiveImage4_7(hdc, 1100, 150, 80);
